...
<div class="card px-5 py-5">
	<div class="card-body">
		...
		<form method="POST" action="{{ route('pesan.update', $pesanan->id) }}" enctype="multipart/form-data">
			@csrf
			@method('PUT')
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-floating mb-3">
							<input type="text" class="form-control" id="nama" name="nama" value="{{ $pesanan->nama }}">
						</div>
					</div>
					<div class="col-md-6">
						<p>No Telp.</p>
						<div class="form-floating mb-3">
							<input type="number" class="form-control" id="notelp" name="notelp" value="{{ $pesanan->notelp }}">
						</div>
					</div>
					<div class="col-md-6">
						<p>Tanggal Pemesanan</p>
						<div class="form-floating mb-3">
							<input type="date" class="form-control" id="tanggal" name="tanggal" placeholder="Tanggal Pesan" value="{{ $pesanan->tanggal }}">
						</div>
					</div>
					<div class="col-md-6">
						<p>Durasi (Hari)</p>
						<div class="form-floating mb-3">
							<input type="number" class="form-control" id="durasi" name="durasi" value="1" value="{{ $pesanan->durasi }}">
						</div>
					</div>
				</div>
				...
				<div class="col-md-12">
					<div class="row">
						<div class="col mt-4">
							...
							<div class="col-md-6 mt-4">
								<div class="form-check">
									<input type="radio" id="deluxe" name="tipe_kamar" class="form-check-input" value="Deluxe" {{ $pesanan->tipe_kamar === 'Deluxe' ? 'checked' : '' }}>
							...
							<div class="col-md-6 mt-4">
								<div class="form-check">
									<input type="radio" id="standard" name="tipe_kamar" class="form-check-input" value="Standard" {{ $pesanan->tipe_kamar === 'Standard' ? 'checked' : '' }}>
						...
						<div class="col mt-4">
							...
							<div class="col-md-6 mt-4">
								<div class="form-check">
									<input class="form-check-input" type="checkbox" value="1" id="smoking_room" name="smoking_room" {{ $pesanan->smoking_room ? 'checked' : '' }}>
							...
							<div class="col-md-6 mt-4">
								<div class="form-check">
									<input class="form-check-input" type="checkbox" value="1" id="breakfast" name="breakfast" {{ $pesanan->breakfast ? 'checked' : '' }}>
